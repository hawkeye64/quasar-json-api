...
Notice for the **params** section, we defer the rerquired example by using **"__exemption": [ "examples" ]** instead. Soime places just don't make sense to have an example, if you have examples elsewhere for that object.
